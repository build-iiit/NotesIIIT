...
export default function RequestDetailsPage() {
 ...
 <Link href="/requests" className="text-primary hover:underline">Go back to board</Link>
 </div>
 );
 ...
 :"text-gray-500 hover:text-primary hover:bg-gray-100 dark:hover:bg-white/5"
 )}
 >
 ...
 className="text-xs font-bold text-gray-500 hover:text-primary flex items-center gap-1.5 px-2 py-1 rounded-full hover:bg-gray-100 dark:hover:bg-white/5 transition-all"
 >
 ...
 return (
 <div className="min-h-screen bg-neutral-50 dark:bg-black selection:bg-primary/30 pb-20">
 {/* Fixed Background Gradients */}
 <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
 <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[var(--gradient-from)] blur-[120px]" />
 <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[var(--gradient-to)] blur-[120px]" />
 </div>

 <div className="relative z-10 pt-24 px-4 max-w-7xl mx-auto">
 {/* Header / Nav */}
 <div className="mb-8 flex justify-between items-center bg-white/50 dark:bg-zinc-900/50 p-4 rounded-2xl border border-white/20 dark:border-white/5 sticky top-20 z-40 shadow-sm">
 <Link
 href="/requests"
 ...
 className="text-xs font-bold text-primary border border-primary/20 bg-primary/5 px-3 py-2 rounded-xl hover:bg-primary/10 transition-colors shadow-sm"
 >
 Mark Complete
 </button>
 )}
 ...
 {/* Main Request Card */}
 <div className="bg-white/70 dark:bg-zinc-900/70 rounded-[2.5rem] p-8 md:p-10 border border-white/50 dark:border-white/10 shadow-xl shadow-gray-200/50 dark:shadow-none relative overflow-hidden group">
 {/* Hover Gradient Effect */}
 <div className="absolute inset-0 bg-gradient-to-br from-[var(--gradient-from)] to-[var(--gradient-via)] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
...
"flex flex-col items-center justify-center w-14 h-16 rounded-2xl transition-all duration-300 border shadow-sm active:scale-95 group/vote",
 ...
 :"bg-white border-gray-100 text-gray-400 hover:border-primary hover:text-primary dark:bg-black/40 dark:border-zinc-800 dark:text-zinc-500 dark:hover:text-primary"
 )}
 >
 <ArrowBigUp className={cn("w-8 h-8 transition-all duration-300", request.isUpvoted ?"scale-110 fill-primary drop-shadow-sm" :"group-hover/vote:-translate-y-0.5")} strokeWidth={1.5} />
 </button>
 ...
 {request.status ==="FULFILLED" && (
 <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 text-primary font-bold uppercase text-[10px] tracking-wider border border-primary/20 shadow-sm">
 ...
 {replyTo && (
 <div className="flex items-center justify-between mx-3 mt-3 mb-1 text-xs font-medium text-primary bg-primary/10 px-4 py-2 rounded-xl animate-in slide-in-from-top-2">
 <span>Replying to {replyTo.name}</span>
 <button onClick={() => setReplyTo(null)} className="p-1 hover:bg-primary/25 rounded-full transition-colors"><X className="w-4 h-4" /></button>
 </div>
 )}
 ...
 {/* CTA Card */}
 <div className="relative overflow-hidden bg-gradient-to-br from-[var(--brand-from)] to-[var(--brand-to)] rounded-[2rem] p-8 text-white shadow-2xl shadow-[var(--glow-color)] group">
 {/* Animated Background */}
 ...
 requestId={requestId}
 trigger={
 <button className="w-full py-4 rounded-xl bg-white text-primary font-bold text-sm tracking-wide hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-black/10">
 ...
 {/* Answers List */}
 <div className="bg-white/50 dark:bg-zinc-900/50 rounded-[2rem] p-6 border border-white/50 dark:border-white/10 shadow-sm">
 ...
 {request.status ==="FULFILLED" && (
 <span className="text-[10px] font-bold text-primary uppercase tracking-wider bg-primary/10 px-2 py-1 rounded-lg border border-primary/20">
 Solved
 </span>
 )}
 </div>
 ...
 <div key={fulfillment.id} className="group bg-white dark:bg-black p-4 rounded-2xl border border-gray-100 dark:border-zinc-800 hover:border-primary dark:hover:border-primary/50 transition-all shadow-sm hover:shadow-md">
 <div className="flex items-start gap-3.5 mb-3">
 <div className="p-2.5 bg-primary/5 dark:bg-primary/10 rounded-xl text-primary group-hover:scale-110 transition-transform">
 <CheckCircle2 className="w-5 h-5" />
 </div>
 <div className="min-w-0">
 <p className="font-bold text-sm text-gray-900 dark:text-white line-clamp-1 group-hover:text-primary dark:group-hover:text-primary transition-colors">
