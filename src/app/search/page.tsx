...
export default function SearchPage() {
 ...
 return results;  }, [debouncedSearch, coursesData, allNotes]);
 ...
 className="w-full bg-white/80 dark:bg-black/40 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-500 pl-14 pr-4 py-4 rounded-xl text-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all duration-200 shadow-lg"
 autoFocus
 />

 {showSuggestions && suggestions.length > 0 && (
 <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-2xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2">
 ...
 className={`w-full text-left px-4 py-3 rounded-lg flex items-center justify-between ${sortBy === type ?"bg-primary/10 text-primary font-bold" :"text-gray-600 dark:text-gray-300 hover:bg-gray-100"}`}
 >
 ...
 {!allNotes.length ? (
 <div className="text-center text-gray-500 dark:text-gray-400 mt-20 p-10 bg-white/40 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-3xl max-w-2xl mx-auto shadow-xl">
