...
export default function CoursesPage() {
 ...
 <div className="bg-white/40 dark:bg-zinc-900/60 border border-white/30 dark:border-white/10 rounded-xl p-6 hover:shadow-[0_8px_30px_rgba(249,115,22,0.2)] transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
