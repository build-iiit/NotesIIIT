...
export default function SocialPage() {
 ...
 <div className="inline-flex items-center gap-1 p-1 bg-white/40 dark:bg-black/40 border border-white/40 dark:border-white/10 rounded-2xl shadow-lg">
 <button
 ...
 <div className="bg-white/40 dark:bg-black/40 rounded-3xl p-6 border border-white/40 dark:border-white/10 shadow-xl">
 <LeaderboardTable />
 </div>
 )}
 </div>
