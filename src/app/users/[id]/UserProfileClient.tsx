        ...
        <div className="min-h-screen pb-12 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative pt-8 pb-12">
                    {/* Glassy Banner */}
                    <div className={`absolute inset-x-0 top-0 h-48 rounded-3xl shadow-2xl overflow-hidden -z-10 bg-gradient-to-r from-[var(--brand-from)] via-[var(--brand-via)] to-[var(--brand-to)] opacity-90 ${themeStyle === 'monochrome' ? 'grayscale' : ''}`}>
