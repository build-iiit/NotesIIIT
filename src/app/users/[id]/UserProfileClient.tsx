...
export function UserProfileClient({ user, achievements, isOwnProfile }: UserProfileClientProps) {
 ...
 className="flex items-center gap-2 px-5 py-2.5 rounded-2xl text-sm font-bold text-gray-800 dark:text-gray-100 bg-white/30 dark:bg-white/10 border border-white/40 dark:border-white/10 hover:bg-white/40 transition-all shadow-xl hover:scale-105 active:scale-95"
 >
 ...
 return (
 <div key={index} className="px-4 py-2 rounded-full bg-white/20 dark:bg-black/20 border border-white/30 dark:border-white/5 shadow-sm flex items-center gap-2 hover:scale-110 transition-transform">
 ...
 <div className="bg-white/10 dark:bg-black/5 rounded-3xl border border-white/20 dark:border-white/5 p-1 shadow-inner">
