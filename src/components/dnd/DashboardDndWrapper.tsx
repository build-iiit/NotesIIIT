...
export function DashboardDndWrapper({ children }: DashboardDndWrapperProps) {
 ...
 <div className="w-64 p-4 rounded-xl bg-white dark:bg-zinc-900 border border-orange-500 shadow-2xl flex items-center gap-3 opacity-90 cursor-grabbing">
 ...
 <div className="w-40 p-4 rounded-xl bg-white dark:bg-zinc-900 border border-yellow-500 shadow-2xl flex items-center gap-3 opacity-90 cursor-grabbing">
