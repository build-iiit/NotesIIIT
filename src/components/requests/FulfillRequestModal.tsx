...
export function FulfillRequestModal({ requestId, trigger }: FulfillRequestModalProps) {
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 animate-in fade-in duration-200" onClick={(e) => e.stopPropagation()}>
 ...
 <h2 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[var(--brand-from)] to-[var(--brand-to)]">
 Fulfill Request
 </h2>
 ...
 className={cn("flex-1 py-4 text-sm font-medium border-b-2 transition-colors", activeTab ==="existing" ?"border-primary text-primary" :"border-transparent text-gray-500 hover:text-gray-700 dark:hover:text-gray-300")}
 >
 Select Existing Note
 </button>
 <button
 onClick={() => setActiveTab("upload")}
 className={cn("flex-1 py-4 text-sm font-medium border-b-2 transition-colors", activeTab ==="upload" ?"border-primary text-primary" :"border-transparent text-gray-500 hover:text-gray-700 dark:hover:text-gray-300")}
 >
 Upload New Note
 </button>
 </div>
 ...
 <button onClick={() => setActiveTab("upload")} className="block mx-auto mt-2 text-primary font-medium hover:underline">Upload one now</button>
 </div>
 ) : (
...
"p-3 rounded-lg border cursor-pointer transition-all flex items-center gap-3 bg-white dark:bg-zinc-800/50",
 ...
 :"border-gray-200 dark:border-zinc-700 hover:border-primary/50 dark:hover:border-primary/50"
 )}
 >
 <div className={cn("w-5 h-5 rounded-full border flex items-center justify-center", selectedNoteId === note.id ?"border-primary bg-primary text-primary-foreground" :"border-gray-300")}>
 ...
 className="px-6 py-2 rounded-lg bg-primary hover:opacity-90 text-primary-foreground font-medium disabled:opacity-50 flex items-center gap-2"
 >
