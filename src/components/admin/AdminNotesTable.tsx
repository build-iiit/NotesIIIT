...
export function AdminNotesTable() {
 ...
 case"GROUP": return"bg-primary/10 text-primary";
 ...
 return (
 <tr key={note.id} className={`hover:bg-gray-50 dark:hover:bg-zinc-800/50 ${selectedNotes.includes(note.id) ?"bg-primary/5" :""}`}>
