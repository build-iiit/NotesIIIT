        ...
        <div className="space-y-8">
            ...
            <div className="flex justify-between items-center bg-white/40 dark:bg-black/40 backdrop-blur-xl p-4 rounded-3xl border border-white/40 dark:border-white/10 shadow-lg">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-gradient-to-tr from-purple-500 to-pink-500 rounded-xl text-white shadow-lg shadow-purple-500/30">
                ...
                {isCreating ? (
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-tr from-purple-600 to-pink-600 text-white rounded-xl font-bold shadow-lg shadow-purple-500/30 hover:scale-105 transition-transform"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {groups?.map(group => (
                        <div key={group.id}
                            ...
                            {/* Decorative bg blob */}
                            <div className="absolute top-0 right-0 w-32 h-32 bg-purple-500/10 rounded-full blur-3xl -z-10 group-hover:bg-purple-500/20 transition-all" />
                            ...
                            <button className="w-full py-2.5 rounded-xl bg-white/50 dark:bg-white/5 hover:bg-purple-500 hover:text-white dark:hover:bg-purple-600 transition-colors text-sm font-bold text-gray-600 dark:text-gray-300">
                                View Details
                            </button>
                        </div>
                    ))}
