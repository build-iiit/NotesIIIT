...
export function GroupsList() {
 ...
 className="group relative bg-white/50 dark:bg-black/50 rounded-3xl p-6 border border-white/40 dark:border-white/10 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all cursor-pointer">
