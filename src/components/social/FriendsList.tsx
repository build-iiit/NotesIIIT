...
export function FriendsList() {
 ...
 <div className={`p-2 rounded-xl text-white shadow-lg bg-primary text-primary-foreground shadow-primary/30`}>
 ...
 className={`flex items-center gap-2 px-5 py-2.5 text-white rounded-xl font-bold shadow-lg hover:scale-105 transition-transform bg-gradient-to-tr from-[var(--button-gradient-from)] to-[var(--button-gradient-to)] shadow-primary/30`}
 >
 ...
 {friends?.map((friend) => (
 <div key={friend.id} className="flex items-center gap-4 p-4 bg-white/50 dark:bg-black/50 rounded-2xl border border-white/40 dark:border-white/10 shadow-sm hover:shadow-md transition-all group relative">
 ...
 <div className="absolute right-0 top-full mt-2 w-48 py-2 bg-white/90 dark:bg-zinc-900/90 rounded-xl border border-white/40 dark:border-white/10 shadow-xl z-50">
 <Link
 ...
 {requests?.map((req) => (
 <div key={req.id} className="p-4 bg-white/60 dark:bg-zinc-900/60 rounded-2xl border border-primary/20 shadow-sm">
