...
export function EditProfileDialog({ user, onClose }: EditProfileDialogProps) {
 ...
 className="absolute bottom-2 right-2 p-2 bg-black/50 hover:bg-black/70 rounded-full text-white transition-all"
 ...
 className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 focus:ring-2 focus:ring-primary outline-none transition-all"
