...
export function ApiKeyDialog({ onClose, onSave }: ApiKeyDialogProps) {
 ...
 {/* Header */}
 <div className="relative p-6 pb-4 bg-primary/20">
 <button
 onClick={handleSkip}
 ...
 <div className="p-3 rounded-xl bg-primary/20 border border-white/20">
 ...
 className="px-5 py-2 rounded-xl text-sm font-semibold text-primary-foreground bg-primary hover:bg-primary/80 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
 >
