...
export function NotificationBell() {
 ...
 className={cn(
"relative p-2 rounded-full bg-gradient-to-br from-white/[0.15] via-white/[0.08] to-white/[0.12] dark:from-white/[0.08] dark:via-white/[0.04] dark:to-white/[0.06] transition-all duration-500 shadow-[0_8px_24px_0_rgba(0,0,0,0.08)] hover:shadow-[0_16px_40px_0_var(--glow-color)] border border-white/25 hover:border-primary/50 hover:scale-[1.08] active:scale-[0.95]",
 isOpen
 ?"from-primary/20 via-[var(--brand-via)]/15 to-[var(--brand-to)]/20 text-primary border-primary/50"
 :"hover:from-primary/20 hover:via-[var(--brand-via)]/15 hover:to-[var(--brand-to)]/20 text-gray-700 dark:text-gray-200"
 )}
...
"relative inline-flex rounded-full h-5 w-5 text-[10px] items-center justify-center text-white font-bold border-2 border-white dark:border-zinc-950 shadow-sm transition-colors",
 ...
 {/* Dropdown Panel */}
 {isOpen && (
 <div className="absolute right-0 mt-4 w-96 max-w-[90vw] bg-white/80 dark:bg-zinc-900/80 border border-white/40 dark:border-white/10 rounded-3xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.2)] ring-1 ring-black/5 z-50 transform origin-top-right animate-in fade-in zoom-in-95 duration-300 overflow-hidden">

 {/* Header */}
 <div className="p-4 border-b border-white/20 dark:border-white/10 flex items-center justify-between bg-white/40 dark:bg-white/5">
...
"ml-1 p-1.5 rounded-full transition-all border",
 ...
 className="text-xs font-semibold text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors flex items-center gap-1.5 px-3 py-1.5 rounded-full hover:bg-white/50 dark:hover:bg-white/10"
 >
 ...
 {/* Tabs */}
 <div className="px-4 pt-2 -mb-px flex gap-6 border-b border-white/20 dark:border-white/10 bg-white/20 dark:bg-white/5">
 {['all','unread'].map((tab) => (
 <button
 key={tab}
...
"pb-3 text-sm font-bold transition-all relative capitalize",
 ...
 {tab}
 {activeTab === tab && (
 <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-primary rounded-full shadow-[0_0_8px_var(--glow-color)]" />
 )}
 </button>
 ))}
 </div>
 ...
 <div className="mx-auto w-16 h-16 bg-gradient-to-br from-white/50 to-white/10 dark:from-white/10 dark:to-transparent rounded-full flex items-center justify-center mb-4 border border-white/20 shadow-lg">
 ...
 className={cn(
"group block p-3 rounded-xl transition-all duration-200 relative overflow-hidden",
 !notification.isRead
 ?"bg-primary/5 dark:bg-primary/10 hover:bg-primary/10 dark:hover:bg-primary/15 border border-primary/20 dark:border-primary/30"
...
"text-sm leading-snug break-words",
 ...
 <div className="h-2.5 w-2.5 rounded-full bg-primary shadow-[0_0_8px_var(--glow-color)] ring-2 ring-white dark:ring-zinc-950" />
 </div>
 )}
 </div>
 </Link>
