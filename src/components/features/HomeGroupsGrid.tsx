...
export function HomeGroupsGrid() {
 ...
 <Users className="h-7 w-7 drop-shadow-lg text-primary" />
 ...
 {/* Group Name */}
 <span className="text-sm font-semibold text-center truncate w-full text-gray-800 dark:text-gray-200 transition-colors relative z-10 mb-2 group-hover:text-primary">
 {group.name}
 </span>
