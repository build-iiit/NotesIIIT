...
export function LeaderboardTable() {
 ...
 {/* Top Notes */}
 <div className="bg-gradient-to-br from-white/[0.15] via-white/[0.08] to-white/[0.12] dark:from-white/[0.08] dark:via-white/[0.04] dark:to-white/[0.06] shadow-xl rounded-2xl p-6 border border-white/20 dark:border-white/10">
 ...
 key={note.id}
 href={`/notes/${note.id}`}
 className="flex items-center gap-4 p-3 rounded-xl bg-white/10 dark:bg-black/10 hover:bg-white/20 dark:hover:bg-white/5 transition-all group border border-transparent hover:border-primary/30"
 >
