...
export function UserStatsCard({
 ...
 <div className="p-3 rounded-xl shadow-lg bg-primary text-primary-foreground">
 <Icon className="h-6 w-6 text-primary-foreground" />
 </div>

 {/* Decorative blur */}
 <div className="absolute top-0 right-0 w-24 h-24 rounded-full blur-2xl transition-all duration-300 bg-primary/10 group-hover:bg-primary/20" />
 </div>
