...
export function HeroSection() {
 ...
 <Link
 href="/login"
 className="px-8 py-3 rounded-full font-semibold text-lg text-gray-800 dark:text-gray-200 bg-gradient-to-br from-white/[0.15] via-white/[0.08] to-white/[0.12] dark:from-white/[0.08] dark:via-white/[0.04] dark:to-white/[0.06] hover:bg-primary/10 transition-all duration-500 shadow-[0_8px_24px_0_rgba(0,0,0,0.08)] hover:shadow-xl border border-white/25 hover:border-primary/50 hover:scale-[1.08] active:scale-[0.95]"
 >
 Get Started
 </Link>
 <Link
